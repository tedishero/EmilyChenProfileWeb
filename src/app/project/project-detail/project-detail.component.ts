...
export class ProjectDetailComponent implements OnInit {
  ...
  private setMetaTags() {
    // sets the title.
    this.title.setTitle(
      `Emily Chen | Graphic Design | ${this.project.englishName} | ${
        this.project.chineseName
      }`
    );
  ...
  ngOnInit() {
    ...
    this.project = {
      ...
      image: {
        ...
        width:
          pageData.data.fields.image["en-US"].fields.file["en-US"].details.image
            .width,
        height:
          pageData.data.fields.image["en-US"].fields.file["en-US"].details.image
            .height,
        ...
        fileName:
          pageData.data.fields.image["en-US"].fields.file["en-US"].fileName
      }
    };
  ...
  public compressedDetailImage(projectImg: ProjectImage): string {
    ...
    let supportWebP =
      typeof window === "undefined" || (<any>window).supportsWebP;
    if (supportWebP) {
      return `${environment.assetUrl}/assets/projects/${
        this.project.name
      }/compressed/${fileNamePrefix}.webp`;
    } else {
      return `${environment.assetUrl}/assets/projects/${
        this.project.name
      }/compressed/${fileNamePrefix}.png`;
    }
  }
  ...
  public onlazyImgLoad(index: number) {
    ...
    let img: HTMLElement = document.getElementById(
      `project-detail-img-${index}`
    );
...
let PhotoSwipeUI_Default = function(pswp, framework) {
  let ui = this;
